...
**WB Tracker** — это современное мобильное приложение для отслеживания динамики цен и рейтинга отзывов на товары маркетплейса Wildberries. Приложение построено на базе высокопроизводительной 3-звенной гибридной архитектуры с защищенным шифрованием локальной базы данных.

---

## 🌟 Ключевые Возможности

- 🎨 **Премиальный интерфейс WB Tracker**: 3-точечные фиолетово-розовые градиенты, плавные свайп-действия на карточках, анимированные графики кривых Безье на Canvas и мгновенное переключение Светлой (`#F5F5F7`) и Тёмной (`#0A0A0E`) тем.
